        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            <div class="small-box bg-info">
              ...
              <a href="<?=base_url('/data_master/mahasiswa');?>" class="small-box-footer">lihat data mahasiswa <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="<?=base_url('/data_master/matakuliah');?>" class="small-box-footer">lihat data mata kuliah <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="<?=base_url('/data_master/nilai');?>" class="small-box-footer">lihat data nilai <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
