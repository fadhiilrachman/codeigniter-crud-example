              ...
              <div class="card-body">
                ...
                <?php if($name=='mhs') { ?>
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nama_mahasiswa" id="nama_mahasiswa_d" placeholder="Masukkan nama mahasiswa...">
                  </div>
                  <?php } ?>
                <?php if($name=='mk') { ?>
                  <div class="form-group">
                    <label for="nama_matakuliah">Nama Mata Kuliah</label>
                    <input type="text" class="form-control" name="nama_matakuliah" id="nama_matakuliah_d" placeholder="Masukkan nama mata kuliah...">
                  </div>
                <?php } ?>
                <?php if($name=='nilai') { ?>
                  <div class="form-group">
                    ...
                    <select name="id_mahasiswa" id="id_mahasiswa_d" class="form-control">
                      ...
                      ?>
                      <option value="<?=$lm->id_mahasiswa;?>"><?=$lm->nama_mahasiswa;?></option>
                      <?php
                        }
                      ?>
                    </select>
                  ...
                  <div class="form-group">
                    ...
                    <select name="id_matakuliah" id="id_matakuliah_d" class="form-control">
                      ...
                      ?>
                      <option value="<?=$lm->id_matakuliah;?>"><?=$lm->nama_matakuliah;?></option>
                      <?php
                        }
                      ?>
                    </select>
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="nilai" id="nilai_d" placeholder="Masukkan nilai...">
                  </div>
                <?php } ?>
              </div>
